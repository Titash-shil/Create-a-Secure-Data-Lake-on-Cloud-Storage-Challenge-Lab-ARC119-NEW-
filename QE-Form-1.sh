...
read -p "${YELLOW_TEXT}${BOLD_TEXT}Enter Your ZONE: ${RESET_FORMAT}" ZONE
...
echo
echo "${YELLOW_TEXT}${BOLD_TEXT}CLICK ON THAT LINK: ${BLUE_TEXT}${BOLD_TEXT}https://console.cloud.google.com/projectselector2/dataplex/groups${RESET_FORMAT}"
